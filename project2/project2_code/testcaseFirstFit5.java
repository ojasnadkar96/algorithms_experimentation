//TESTCASE (First Fit) 5: Running time random input of 100000 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseFirstFit5 {
	...
	public static void main(String args[]) {
		...
		testcaseFirstFit5 ff5 = new testcaseFirstFit5();
		int testSize = 100000;
		String filename = "test100000.txt";
		ff5.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			ff5.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(ff5.data);
			double dataSum = binfunc.getSum(ff5.data);
