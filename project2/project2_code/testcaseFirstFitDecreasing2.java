//TESTCASE (First Fit Decreasing) 2: Running time random input of 100 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseFirstFitDecreasing2 {
	...
	public static void main(String args[]) {
		...
		testcaseFirstFitDecreasing2 ffd2 = new testcaseFirstFitDecreasing2();
		int testSize = 100;
		String filename = "test100.txt";
		ffd2.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			ffd2.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(ffd2.data);
			double dataSum = binfunc.getSum(ffd2.data);
