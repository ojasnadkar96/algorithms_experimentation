//TESTCASE (First Fit Decreasing) 4: Running time random input of 10000 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseFirstFitDecreasing4 {
	...
	public static void main(String args[]) {
		...
		testcaseFirstFitDecreasing4 ffd4 = new testcaseFirstFitDecreasing4();
		int testSize = 10000;
		String filename = "test10000.txt";
		ffd4.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			ffd4.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(ffd4.data);
			double dataSum = binfunc.getSum(ffd4.data);
