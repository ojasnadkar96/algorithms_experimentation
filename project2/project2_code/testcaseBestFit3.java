//TESTCASE (Best Fit) 3: Running time random input of 1000 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseBestFit3 {
	...
	public static void main(String args[]) {
		...
		testcaseBestFit3 bf3 = new testcaseBestFit3();
		int testSize = 1000;
		String filename = "test1000.txt";
		bf3.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			bf3.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(bf3.data);
			double dataSum = binfunc.getSum(bf3.data);
