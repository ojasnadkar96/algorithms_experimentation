//TESTCASE (Best Fit) 2: Running time random input of 100 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseBestFit2 {
	...
	public static void main(String args[]) {
		...
		testcaseBestFit2 bf2 = new testcaseBestFit2();
		int testSize = 100;
		String filename = "test100.txt";
		bf2.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			bf2.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(bf2.data);
			double dataSum = binfunc.getSum(bf2.data);
