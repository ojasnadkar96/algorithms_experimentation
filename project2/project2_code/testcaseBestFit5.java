//TESTCASE (Best Fit) 5: Running time random input of 100000 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseBestFit5 {
	...
	public static void main(String args[]) {
		...
		testcaseBestFit5 bf5 = new testcaseBestFit5();
		int testSize = 100000;
		String filename = "test100000.txt";
		bf5.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			bf5.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(bf5.data);
			double dataSum = binfunc.getSum(bf5.data);
