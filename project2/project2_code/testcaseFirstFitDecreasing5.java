//TESTCASE (First Fit Decreasing) 5: Running time random input of 100000 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseFirstFitDecreasing5 {
	...
	public static void main(String args[]) {
		...
		testcaseFirstFitDecreasing5 ffd5 = new testcaseFirstFitDecreasing5();
		int testSize = 100000;
		String filename = "test100000.txt";
		ffd5.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			ffd5.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(ffd5.data);
			double dataSum = binfunc.getSum(ffd5.data);
