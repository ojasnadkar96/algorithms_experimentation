//TESTCASE (First Fit Decreasing) 3: Running time random input of 1000 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseFirstFitDecreasing3 {
	...
	public static void main(String args[]) {
		...
		testcaseFirstFitDecreasing3 ffd3 = new testcaseFirstFitDecreasing3();
		int testSize = 1000;
		String filename = "test1000.txt";
		ffd3.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			ffd3.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(ffd3.data);
			double dataSum = binfunc.getSum(ffd3.data);
