//TESTCASE (Best Fit Decreasing) 5: Running time random input of 100000 floating point numbers in range [0.1-0.8]

import java.util.*;
import java.math.*;
import java.text.*;

public class testcaseBestFitDecreasing5 {
	...
	public static void main(String args[]) {
		...
		testcaseBestFitDecreasing5 bfd5 = new testcaseBestFitDecreasing5();
		int testSize = 100000;
		String filename = "test100000.txt";
		bfd5.data = binfunc.readFile(filename);
		...
		for(int i=1; i<=10; i++) {
			...
			System.out.println();
			bfd5.data = binfunc.genNumbers(testSize);
			double numBins = binfunc.getBins(bfd5.data);
			double dataSum = binfunc.getSum(bfd5.data);
