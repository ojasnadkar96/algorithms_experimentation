//TESTCASE (Customized Shell Sort) 4: Running time on uniform and almost sorted input of 100000 numbers

import java.util.*;

public class testcaseShellCustomized4 {
	...
	public static void main(String args[]) {
		...
		testcaseShellCustomized4 sct4 = new testcaseShellCustomized4(); //testcase obj
		...
		sct4.almostSort = sortfunc.generateAlmostSorted(100000);
